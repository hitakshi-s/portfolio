          ...
          <ScrollReveal delay={0.1}>
            <div className="lg:sticky lg:top-32">
              ...
              <div className="mt-6 flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-accent-light border border-accent/20 flex items-center justify-center text-accent font-bold text-sm flex-shrink-0">
                  HS
                </div>
                <div>
