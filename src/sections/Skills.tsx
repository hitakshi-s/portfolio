...
function SkillCard({ category, skills, delay }: SkillCategory & { delay: number }) {
  ...
  return (
    <ScrollReveal delay={delay}>
      ...
      <motion.div
        className="relative h-[248px] bg-surface border border-border rounded-2xl p-6 group overflow-hidden transition-colors duration-300 hover:border-accent/40 shadow-lg shadow-black/[0.04]"
        animate={{
          rotateX: tilt.x,
          rotateY: tilt.y,
          y: tilt.hover ? -5 : 0,
